...
import { Loader2, ShieldAlert, Users, Lock, CheckCircle, AlertCircle } from "lucide-react"
...
export default function RoleAndPermissionPage() {
  ...
  const handlePermissionToggle = (permissionId: number, allowed: boolean) => {
    setRolePerms((prev) => {
      ...
      if (existing) {
        return prev.map((rp) => (rp.permission_id === permissionId ? { ...rp, allowed } : rp))
      } else {
  ...
  if (pageLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
        ...
        <h2 className="text-xl font-medium text-gray-700">Loading permissions system...</h2>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-gray-50 min-h-screen">
      ...
      {updateStatus && (
        ...
        >
          {updateStatus.type === "success" ? <CheckCircle className="h-4 w-4" /> : <AlertCircle className="h-4 w-4" />}
          <AlertTitle>{updateStatus.type === "success" ? "Success" : "Error"}</AlertTitle>
        ...
        <TabsContent value="users" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Assign roles to users to control their access to features</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-muted/50 border-b">
                      ...
                      <th className="py-3 px-4 text-left font-medium">Current Role</th>
        ...
        <TabsContent value="permissions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure which permissions are granted to each role</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <Button onClick={handleSavePermissions} disabled={saving || loading} className="sm:self-end">
                  {saving ? (
                    <>
              ...
              {loading ? (
                ...
                <div className="text-center py-12 border rounded-md bg-muted/20">
                  ...
                  <p className="text-sm text-muted-foreground">Please check if permissions are properly seeded.</p>
                </div>
              ) : (
                <div className="overflow-x-auto rounded-md border">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-muted/50 border-b">
                        ...
                        <th className="py-3 px-4 text-center font-medium w-[120px]">Allowed</th>
                      </tr>
                    </thead>
                    <tbody>
                      {permissions.map((perm) => {
                        ...
                        return (
                          <tr key={perm.id} className="border-b hover:bg-muted/50 transition-colors">
